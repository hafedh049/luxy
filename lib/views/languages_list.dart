  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <IconButton>[IconButton(onPressed: () {}, icon: const Icon(FontAwesome.magnifying_glass_arrow_right_solid, color: white, size: 15))],
                  ...
                  if (snapshot.hasData) {
                    ...
                    return ListView.separated(
                      ...
                      itemBuilder: (BuildContext context, int index) => GestureDetector(
                        onTap: () => setState(() => _currentLanguage = data[index]["code"]),
                        child: Container(
                          padding: const EdgeInsets.all(16),
